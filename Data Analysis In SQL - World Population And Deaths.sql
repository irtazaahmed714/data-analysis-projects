...
-- by income groups.
drop table if exists #under_twenty_population_table
create table #under_twenty_population_table
(location varchar(100), year numeric, under_twenty_population decimal(20,4))

insert into #under_twenty_population_table

select location, year, (zero+ one+ two+ three+ four+ five+ six+ seven+ eight+ nine+ ten+ eleven+
twelve+ thirteen+ forteen+ fifteen+ sixteen+ seventeen+ eighteen+ nineteen) as under_twenty_population
from pop..population where type = 'Income Group'

select *, (((under_twenty_population - lag(under_twenty_population) over (partition by location order by year, 
location)) / lag(under_twenty_population) over (partition by location order by year, location))*100) 
as under_twenty_population_percent_change_from_previous_year from
#under_twenty_population_table
...
as twenty_to_forty_population_percent_change_from_previous_year from
...
-- Checking 61-80 population and percentage change in 61-80 population from previous year
-- by income groups.
drop table if exists #sixty_one_to_eighty_population_table
create table #sixty_one_to_eighty_population_table
(location varchar(100), year numeric, sixty_one_to_eighty_population decimal(20,4))

insert into #sixty_one_to_eighty_population_table
...
(partition by location order by year, location)) / lag(sixty_one_to_eighty_population) over 
(partition by location order by year, location))*100) 
as sixty_one_to_eighty_population_percent_change_from_previous_year from
#sixty_one_to_eighty_population_table




-- Checking 81-100+ population and percentage change in 81-100+ population from previous year
-- by income groups.
drop table if exists #eighty_one_to_hundred_plus_population_table
create table #eighty_one_to_hundred_plus_population_table
(location varchar(100), year numeric, eighty_one_to_hundred_plus_population decimal(20,4))

insert into #eighty_one_to_hundred_plus_population_table

select location, year, (eighty_one+ eighty_two+ eighty_three+ eighty_four+ eighty_five+
eighty_six+ eighty_seven+ eighty_eight+ eighty_nine+ ninety+ ninety_one+ ninety_two+ ninety_three+ ninety_four+
ninety_five+ ninety_six+ ninety_seven+ ninety_eight+ ninety_nine+ hundred_plus) as eighty_one_to_hundred_plus_population
from pop..population where type = 'Income Group'

select *, (((eighty_one_to_hundred_plus_population - lag(eighty_one_to_hundred_plus_population) over 
(partition by location order by year, location)) / lag(eighty_one_to_hundred_plus_population) over 
(partition by location order by year, location))*100) 
as eighty_one_to_hundred_plus_population_percent_change_from_previous_year from
#eighty_one_to_hundred_plus_population_table
...
-- Calculating infant population for each development group and the percentage in it
-- over a five-year interval.

drop table if exists #infant_population_change_five_years_table
create table #infant_population_change_five_years_table
(location varchar(100), year numeric, infant_population_change_five_years decimal(20,4))

insert into #infant_population_change_five_years_table
select location, year, zero as 
#infant_population_change_five_years
from pop..population where type = 'Development Group'
and year in (1950, 1955, 1960, 1965, 1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015, 2020)

select *, (((infant_population_change_five_years - lag(infant_population_change_five_years) over (partition by location order by 
year, location)) / lag(infant_population_change_five_years) over (partition by location order by year, location))*100)
as infant_population_change_five_years
from #infant_population_change_five_years_table
...
-- Calculating the total population in age group 61-80 and percentage change in it from previous period
-- for all countries over a five-year interval.
drop table if exists #sixty_one_to_eighty_population_change_five_years_table
create table #sixty_one_to_eighty_population_change_five_years_table
(location varchar(100), year numeric, sixty_one_to_eighty_population_five_years decimal(20,4))

insert into #sixty_one_to_eighty_population_change_five_years_table
select location, year, (sixty_one+ sixty_two+ sixty_three+ sixty_four+ sixty_five+ sixty_six+ sixty_seven+
sixty_eight+ sixty_nine+ seventy + seventy_one+ seventy_two+ seventy_three+ seventy_four+ seventy_five+ seventy_six+
seventy_seven+ seventy_eight+ seventy_nine+ eighty)
as sixty_one_to_eighty_population_five_years
from pop..population where type not in ('World', 'Label/Separator', 'SDG region', 'Development Group', 'Special other', 
  'Income Group', 'Region', 'Subregion')
and year in (1950, 1955, 1960, 1965, 1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015, 2020)

select *, (((sixty_one_to_eighty_population_five_years - lag(sixty_one_to_eighty_population_five_years) over 
(partition by location order by year, location)) / lag(sixty_one_to_eighty_population_five_years) over 
(partition by location order by year, location))*100) as sixty_one_to_eighty_population_change_five_years
from #sixty_one_to_eighty_population_change_five_years_table


-- Calculating the total population in age group 81-100+ for all countries over a five-year interval.
drop table if exists #eighty_one_to_hundred_plus_population_five_years_table
create table #eighty_one_to_hundred_plus_population_five_years_table
(location varchar(100), year numeric, eighty_one_to_hundred_plus_population_five_years decimal(20, 4))

insert into #eighty_one_to_hundred_plus_population_five_years_table
select location, year,
    (eighty_one + eighty_two + eighty_three + eighty_four + eighty_five + eighty_six + eighty_seven + 
	eighty_eight + eighty_nine + ninety + ninety_one + ninety_two +ninety_three + ninety_four + ninety_five +
	ninety_six + ninety_seven + ninety_eight + ninety_nine + hundred_plus) as 
	eighty_one_to_hundred_plus_population_five_years
from pop..population
where type not in ('World', 'Label/Separator', 'SDG region', 'Development Group', 'Special other', 
  'Income Group', 'Region', 'Subregion')
and year in (1950, 1955, 1960, 1965, 1970, 1975, 1980, 1985, 1990, 1995, 2000, 2005, 2010, 2015, 2020)

select *, (((eighty_one_to_hundred_plus_population_five_years - lag(eighty_one_to_hundred_plus_population_five_years) over 
(partition by location order by year, location)) / lag(eighty_one_to_hundred_plus_population_five_years) over 
(partition by location order by year, location))*100) as eighty_one_to_hundred_plus_population_change_five_years
from #eighty_one_to_hundred_plus_population_five_years_table
...
as
(
select DISTINCT location, year, 
    (zero_mort+ one_mort+ two_mort+ three_mort+ four_mort+ five_mort+ six_mort+ seven_mort+ 
    eight_mort+ nine_mort+ ten_mort+ eleven_mort+ twelve_mort+ thirteen_mort+ forteen_mort+
    fifteen_mort+ sixteen_mort+ seventeen_mort+ eighteen_mort+ nineteen_mort+ twenty_mort+ twenty_one_mort+
    twenty_two_mort+ twenty_three_mort+ twenty_four_mort+ twenty_five_mort+ twenty_six_mort+ twenty_seven_mort+
    twenty_eight_mort+ twenty_nine_mort+ thirty_mort+ thirty_one_mort+ thirty_two_mort+ thirty_three_mort+
    ...
    eighty_seven_mort+ eighty_eight_mort+ eighty_nine_mort+ ninety_mort+ ninety_one_mort+ ninety_two_mort+ 
    ninety_three_mort+ ninety_four_mort+ ninety_five_mort+ ninety_six_mort+ ninety_seven_mort+ 
    ninety_eight_mort+ ninety_nine_mort+ hundred_plus_mort) as total_deaths, 
    zero_mort as infant_deaths,
    (thirteen_mort+ forteen_mort+ fifteen_mort+ sixteen_mort+ seventeen_mort+ eighteen_mort+ nineteen_mort) as teen_deaths, 
    (zero_mort+ one_mort+ two_mort+ three_mort+ four_mort+ five_mort+ six_mort+ seven_mort+ 
    eight_mort+ nine_mort+ ten_mort+ eleven_mort+ twelve_mort+ thirteen_mort+ forteen_mort+
...
as
(
select DISTINCT location, year, (zero_mort+ one_mort+ two_mort+ three_mort+ four_mort+ five_mort+ six_mort+ seven_mort+ 
eight_mort+ nine_mort+ ten_mort+ eleven_mort+ twelve_mort+ thirteen_mort+ forteen_mort+
fifteen_mort+ sixteen_mort+ seventeen_mort+ eighteen_mort+ nineteen_mort+ twenty_mort+ twenty_one_mort+
twenty_two_mort+ twenty_three_mort+ twenty_four_mort+ twenty_five_mort+ twenty_six_mort+ twenty_seven_mort+
twenty_eight_mort+ twenty_nine_mort+ thirty_mort+ thirty_one_mort+ thirty_two_mort+ thirty_three_mort+
...
(
select DISTINCT popu.location, popu.year, popu.type, (popu.zero+ popu.one+ popu.two+ popu.three+ popu.four+ popu.five+
